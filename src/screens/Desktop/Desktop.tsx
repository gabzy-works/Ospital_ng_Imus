...
export const Desktop = (): JSX.Element => {
  ...
  return (
    <div className="bg-white w-full min-h-screen">
      ...
      <header className="w-full h-[140px] bg-white border-0 border-none shadow-[0px_4px_4px_#00000040] relative z-10" />
      ...
      <div className="flex flex-row justify-center w-full">
        <div className="bg-white w-full max-w-[1400px] relative scale-75 origin-top">
          <div className="absolute w-full h-full top-0 left-0">
            ...
            {/* Main title - centered */}
            <h1 className="absolute w-full top-[40px] text-center font-sans font-black text-[#05196a] text-[44px] tracking-[0] leading-[normal]">
              OSPITAL NG IMUS
            </h1>
              ...
              <form className="flex flex-col gap-5 items-center">
                {formFields.map((field) => (
                  <div key={field.id} className="relative">
                    <Input
                      id={field.id}
                      className="w-[450px] h-[58px] bg-white rounded-[24px] shadow-[0px_4px_4px_#00000040] px-6 text-[26px] placeholder:text-[#838383]"
